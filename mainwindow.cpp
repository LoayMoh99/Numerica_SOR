    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->i->setValidator( new QIntValidator(-100, 100,  this) );
...
/////////////////////////////////////////create 2d matrix here
        ...
        /*arr[0][0]= ui->x1->text().toDouble();
        arr[1][0]= ui->x2->text().toDouble();
        arr[2][0]= ui->x3->text().toDouble();
        arr[0][1]= ui->y1->text().toDouble();
        arr[1][1]= ui->y2->text().toDouble();
        arr[2][1]= ui->y3->text().toDouble();
        arr[0][2]= ui->z1->text().toDouble();
        arr[1][2]= ui->z2->text().toDouble();
        arr[2][2]= ui->z3->text().toDouble();*/
